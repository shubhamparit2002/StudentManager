...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        ...
        $stmt = $pdo->prepare("UPDATE student SET name = ?, email = ?, address = ?, class_id = ? WHERE id = ?");
        ...
        <form action="" method="post" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="address"
                          class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"><?= $student['address'] ?></textarea>
            </div>
